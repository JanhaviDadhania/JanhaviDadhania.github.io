...
- Background: [Artificial Life — Philosophy (Wikipedia)](https://en.wikipedia.org/wiki/Artificial_life#Philosophy) — *"life as it could be"* (Chris Langton's framing of ALife vs biology's "life as it is").
